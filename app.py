...
class RegistrationModule:
    ...
    def getFaceEmbedding(self):
        ...
        ap.add_argument("--embeddings", default="./src/faceEmbeddingModels/embeddings.pickle")
        # Argument of insightface
        ap.add_argument('--image-size', default='112,112', help='')
        ap.add_argument('--model', default='./src/insightface/models/model-y1-test2/model,0', help='path to load model.')
    ...
    def trainModel(self):
        ...
        ap.add_argument("--model", default="./src/faceEmbeddingModels/my_model.h5",
                        help="path to output trained model")
        ap.add_argument("--le", default="./src/faceEmbeddingModels/le.pickle",
