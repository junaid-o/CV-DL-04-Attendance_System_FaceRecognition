...
sys.path.append('./src/insightface/deploy')
sys.path.append('./src/insightface/src/common')
####################################################
...
class FacePredictor():
    def __init__(self):
        try:
            ...
            self.model = "./src/insightface/models/model-y1-test2/model,0"
            self.threshold = 1.24
            self.det = 0
            self.model_filename = './src/com_in_ineuron_ai_sorting/model_data/mars-small128.pb'

            #################################
            print(">>"*10, self.model_filename)
            #################################
            ...
            self.embeddings = "./src/faceEmbeddingModels/embeddings.pickle"
            self.le = "./src/faceEmbeddingModels/le.pickle"
